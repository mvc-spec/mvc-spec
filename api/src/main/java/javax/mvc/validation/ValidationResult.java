...
/**
 * <p>Describes the validation result of all resource fields and resource
 * method parameters which are annotated with {@link javax.validation.Valid}.</p>
 *
 * <p>Controller methods which declare a parameter of this type will be executed
 * even if the validation for fields and method parameters fails.</p>
 *
...
public interface ValidationResult extends Iterable<ConstraintViolation<?>> {
     ...
     *
     * @param propertyPath The property path (e.g. <code>person.age</code>)
     * @return All constraint violations detected
     * @see #getViolation(String)
     */
    Set<ConstraintViolation<?>> getViolations(String propertyPath);
     ...
     * are more than one detected and <code>null</code> if no violation was detected.
     *
     * @param propertyPath The property path (e.g. <code>person.age</code>)
     * @return The first constraint violation or <code>null</code> if there are no violations.
     */
