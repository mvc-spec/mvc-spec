\newcommand{\Controller}{\code{@Controller}}
\newcommand{\View}{\code{@View}}
\newcommand{\Viewable}{\code{Viewable}}
\newcommand{\Models}{\code{Models}}
\newcommand{\ViewEngine}{\code{ViewEngine}}
\newcommand{\mvc}{MVC}
\newcommand{\Named}{\code{@Named}}
...
\newcommand{\ValExc}{\code{Validation\-Exception}}
\newcommand{\ConstVioExc}{\code{Constraint\-Violation\-Exception}}
\newcommand{\ValRes}{\code{javax.mvc.validation.ValidationResult}}
\newcommand{\ControllerMatched}{\code{ControllerMatched}}
...
\newcommand{\llb}{$[\![$}
\newcommand{\rrb}{$]\!]$}
\newcommand{\assertref}[1]{\textbf{\llb\ref{mvc:#1}\rrb}}

\makeatletter
\newcommand{\assert}[1]{%
\def\@itemlabel{\textbf{\llb{mvc:#1}\rrb}}
\item
\def\@currentlabel{mvc:#1}\label{mvc:#1}}
\makeatother
