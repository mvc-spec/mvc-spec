...
\usepackage[
  pdftitle={MVC},
  pdfauthor={Santiago Pericas-Geertsen and Manfred Riem, Oracle},
  pdfsubject={MVC API},
  pdfkeywords={Model View Controller API},
  pdftex,
  colorlinks=true,
  linkcolor=black,
  citecolor=black,
