...
In either case, the HTTP status code returned is 302. Note that redirects require client 
cooperation (they must be supported by clients) and result in a completely new 
request-response exchange in order to complete the redirection.
