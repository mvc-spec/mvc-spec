...
This exception mapper updates \code{ErrorDataBean} and returns the \code{error.jsp} view 
...
MUST be annotated with \code{@Inject} to guarantee proper bean initialization.
